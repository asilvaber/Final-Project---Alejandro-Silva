...
% INPUT PARAMETERS FOR THE COMPUTATION OF THE FIRST MODE OF THE SNAPTHROUGH
% ABSORBER
...
InitFreqStep = -1e-6;
% Maximum absolute value of the frequency stepsize for the predictor phase
MaxFreqStep = 5e-5;
% Minimum absolute value of the frequency stepsize for the predictor phase
MinFreqStep = 1e-99;
% Maximum the number of NNMs to be obtained (first stopping condition)
MaxPtsCurve = 60;
